...
namespace KMHSSS
{
    public partial class Student_Admission_Class_Wise_Report_Frm : Form
    {
        string query;
        SqlConnection con = new SqlConnection(@"Data Source=.\SQLEXPRESS;Initial Catalog=DBKMHSS;Integrated Security=True");
        public Student_Admission_Class_Wise_Report_Frm()
        {
            InitializeComponent();
        }
        ...
        private void View_Btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    query = "select * from Student_Admission_Master_Table where Class='" + Class_CBox.Text + "' and Section='" + Sec_CBox.Text + "' and SYear='"+SYear_CBox.Text +"' and EYear='"+EYear_Txt.Text +"' order by Class,Section,Gender,Std_Name Asc";
        ...
        private void Student_Admission_Class_Wise_Report_Frm_Load(object sender, EventArgs e)
        {
            try
            {
                fill_Class_CBox();
