...
class BenQusCommon extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        ApplyForCountry = this.props.ApplyForCountry;
        pensionDocID = this.props.PensionDocID;
        this.setState({ DateSigned: new Date() });
        // props value
        this.setState({ ApplyBenefits: ApplyForCountry });
        ...
        if (Countryvalue != null || Countryvalue != "") {
            ...
            ApplyForCountry = Params.get("CountryName");
            pensionDocID = Params.get("DocumentCode");
        } else {
            country_code = this.props.country_code;
            ApplyForCountry = this.props.ApplyForCountry;
            pensionDocID = this.props.PensionDocID;
        ...
        if (Params != null || Params != "") {
            if (Mode != null || Mode != "") {
                if (Mode == "E") {
                    this.handleEdit(Benefit);
                }
                else {
                    this.GeneralAndBenPart1AutoPopulate(this);
                    this.ResidencyQusAutoPopulate(this);
                }
            }
            else {
                this.GeneralAndBenPart1AutoPopulate(this);
    ...
    ResidencyQusAutoPopulate(event) {
        var thisObj = this;
        let UserID;
    ...
    GeneralAndBenPart1AutoPopulate(event) {
        var thisObj = this;
        let UserID;
        //let BenQusAutoAPIUrl = "https://5zykex8q94.execute-api.us-west-2.amazonaws.com/Dev/GPA_AutopopulateData_Lambda";
        let BenQusAutoAPIUrl = "https://ch06is45h0.execute-api.us-west-2.amazonaws.com/Dev/";
            ...
            <div >
                <Col xs={12} md={12} style={newstyle}>
                    <Panel eventKey="1" defaultExpanded={true}>
                        <Panel.Heading>
                            <Panel.Title >{this.props.ApplyForCountry} Form</Panel.Title>
                        </Panel.Heading>
                                ...
                                <Col xs={12} md={12} className="PanelText">
                                    <Col xs={12} md={12} >
                                        <Col xs={12} md={12} className="input-fileds align-fileds">
                                            <label>I apply for all benefits for which I am eligible under the provisions of the social security agreement between the United States and {this.props.ApplyForCountry}</label>
                                        </Col>
                                    </Col>
                                    <Col xs={12} md={12} >
    ...
    handlerSubmit(e) {
        ...
        if (isValid) {
            ...
            var allowPensionFormGeneration = false;
            var BQP2CompStatus = "P";
            if (this.state.ischecked) {
                SignatureBase64 = EncodedData[1] != "" ? EncodedData[1] : "";
                allowPensionFormGeneration = true;
                BQP2CompStatus = "C";
            }
    ...
    handleAppDocTrackEntry(PensionEmpID, DocID) {
        ...
        let DocIDData = {
            ...
            SendDate: new Date(),
            DownloadPensionAppFileLink: "https://s3-us-west-2.amazonaws.com/gpa-dev-mitosis/applicant/" + emailresult + "/" + "PensionApplication" + "_" + country_code + ".pdf",
        };
...
export default connect(mapReducerStateToProps, mapDispatchToProps)(BenQusCommon);