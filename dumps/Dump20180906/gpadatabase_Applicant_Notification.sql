...
DROP TABLE IF EXISTS `Applicant_Notification`;
...
CREATE TABLE `Applicant_Notification` (
  ...
  `View_Status` char(1) NOT NULL DEFAULT 'N',
...
LOCK TABLES `Applicant_Notification` WRITE;
/*!40000 ALTER TABLE `Applicant_Notification` DISABLE KEYS */;
/*!40000 ALTER TABLE `Applicant_Notification` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-09-06 11:28:42
